...
import { 
  ...
  ArrowRight, BookOpen, Sparkles, X, FileText, Award, Compass, Brain, Library, Flame, Activity, ShieldCheck, GraduationCap
} from 'lucide-react';
...
export default function CommandPaletteModal() {
  ...
  const navItems = [
    ...
    { id: 'degree', title: 'CTY Degree Pathway & Co-op Prerequisite Tree (6 Semesters, Certs & Clearance)', category: 'Navigation', icon: GraduationCap, action: () => setCurrentView('degree') },
